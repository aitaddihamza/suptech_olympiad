            ...
            <div class="w-full text-center">
                <form
                    ...
                    <h1 class="font-bold tracking-wider text-2xl xl:text-2xl mb-8 w-full text-gray-600">
                        {{ $game->exists ? __('Edit Game') : __('Create a New Game') }}
                    </h1>
                    ...
                    <div class="py-2 text-left flex flex-col items-start">
                        ...
                        <select id="activity" name="activity"
                            ...
                            <option value="chess" {{ old('activity', $game->activity) == 'chess' ? 'selected' : '' }}>Chess
                            </option>
                        </select>
                        @error('activity')
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-2">
                        <div class="py-2 text-left flex-1">
                            <label for="score1" class="block text-sm font-medium text-gray-700">Player 1
                                Score</label>
                        ...
                        <div class="py-2 text-left flex-1">
                            <label for="score2" class="block text-sm font-medium text-gray-700">Player 2
                                Score</label>
                    ...
                    <div class="py-2 text-left">
                        <label for="schedule_date" class="block text-sm font-medium text-gray-700">schedule At</label>
                    ...
                    <div class="py-2">
                        <button type="submit" class="btn bg-black rounded-sm">
                            <span class="pl-2 mx-1">{{ $game->exists ? 'Update Game' : 'Create Game' }}</span>
                        </button>
                    </div>
                </form>
            </div>
